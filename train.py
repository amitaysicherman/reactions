...
def args_to_name(args):
    ...
    return f"{transfer}ds-{datasets}_s-{args.size}_m-{args.meta_type}_l-{args.max_length}_b-{args.batch_size}_ec_tokens-{args.ec_tokens}_skip_no_emb-{args.skip_no_emb}"
